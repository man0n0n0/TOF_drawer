...
def homing():
        s.set_max_speed(-back_speed) 
        s.run_speed(-1) #move forward
        ...
        s.set_current_position(0) #set position as 0 point
        s.move_to(0) #set the target to the same value to avoid unwanted movement
